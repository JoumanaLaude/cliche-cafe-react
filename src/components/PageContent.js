...
export const PageContent = {
   ...
   aboutUs: {
      title: "About Us",
      content: `Our goal for Cliche Cafe is to be an open community space for the public to find a place where
   ...
   eventSection: {
      title: "Cliche Events",
      content: `Some of Cliche Cafe's monthly events include book club meets, mahjong games and lessons, guest
      speakers, and board game nights.`,
   ...
   reserveSpace: {
      title: "Reserve Space",
      content: `Reserve a spot for yourself or a party to eat, drink, or lounge at Cliche!`,
      img: verticalimg
   }
}